...
export default function ActionModal({ title, deleteAction , children, open = false, close }) {
  const ref = useRef();
            ...
            >
              ...
              <div className="flex items-center justify-center h-12 px-4 md:px-5 p-1 md:p-2 border-t border-gray-200 rounded-b dark:border-gray-600">
                <button
                  ...
                  className="py-1 px-5 pb-1.5 text-sm font-bold text-white focus:outline-none bg-green-400 rounded-lg border border-gray-200 hover:bg-green-500 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:hover:bg-gray-800 dark:text-gray-50 dark:border-gray-600 dark:hover:text-white dark:bg-gray-700"
                >
                  تأكيد
                </button>
              </div>
